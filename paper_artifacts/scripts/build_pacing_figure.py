...
PAPER = HERE.parent
SOURCE = PAPER / "data/fig5_plot_data.csv"
...
def main():
    ...
    parser.add_argument("--out", type=Path, default=PAPER / "exports")
    ...
    sidecar = {"source_relative_to_paper": SOURCE.relative_to(PAPER).as_posix(),
